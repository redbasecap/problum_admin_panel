...
{
    public function pdfmergefun(){
        $oMerger = PDFMerger::init();
        
        $oMerger->addPDF(public_path('pdf/2022-08-30_115490_john_seth.pdf'), 'all');
      $oMerger->addPDF(public_path('pdf/demopdf.pdf'), 'all');

       $fileName = 'merge_'.time().'.pdf';
        $oMerger->merge();
       $oMerger->save(public_path('pdf/'.$fileName));
           
       return response()->download(public_path('pdf/'.$fileName));

//     $resource = fopen(public_path('pdf/demopdf.pdf'), 'r');
