...
//   all error will Found here
    ...
    'err_fail_to_auth' => "invalid user name or password",
    ...
    'errr_no_post' => 'No post found',
    

//    success
    'succ' => 'success',
    
    'succ_post_add' => 'Post added successfully',
    'succ_post_edit' => 'Post updated successfully',
    
    
    //
    
    'succ_profile_update' => 'Profile update successfully',
    

    'succ_add_solution' => 'Solution added successfully',
    'succ_add_mee_too' => 'Me too add successfully',
    'succ_solution_status' => 'Solution status changed successfully',
    'succ_post_delete' => 'Post Deleted successfully',
    'succ_noti_list' => 'Notification listing successfully',
    'succ_post_list' => 'Post listing successfully',
    'succ_comment_list' => 'Comment listing successfully',
    'succ_comment_add' => 'Comment added successfully',
    'succ_category_add' => 'Category added successfully',
    'succ_post_detail' => 'Post Detail successfully',
